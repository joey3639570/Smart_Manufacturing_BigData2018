...
#data loading
Train_file = '/home/cch/Downloads/pytorchworkplace/pytorch/preliminary/0903traindata.csv'
Test_file = '/home/cch/Downloads/pytorchworkplace/pytorch/preliminary/0903testdata.csv'

def train_data_loading(FILE):
    #data loading
    FILENAME = FILE
...
def eval(test_file):
    FILENAME = test_file
    df, datalist = datafunc.load_test_data(FILENAME,10) #Load Test data
    data = datalist.values #Transform to numpy array
    data = t.FloatTensor(data) #Transform to tensor
...
def main():
    ...
    if MODE == TRAIN:
        ...
        train_dataset,test_dataset = train_data_loading(Train_file)
